"""
Django settings for helps_booking_system project.
...
SECRET_KEY = '(-!v78_f#&4k3r0(un=1gcng=rpxif#*#q!@q^p!4k1=cj^1p='
...
WSGI_APPLICATION = 'helps_booking_system.wsgi.application'
...
STATICFILES_DIRS = [os.path.join(BASE_DIR, "helps_student/static")]
